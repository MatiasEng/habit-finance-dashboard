            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-8">
                ...
                <div className="flex-1">
                  ...
                  {/* Edit Button - Will open EditProfile modal */}
                  <div className="mt-6">
                    <button
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 border border-red-100">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  disabled={isDeleting}
                  className="w-full flex items-center justify-center gap-2 bg-red-600 text-white py-3 rounded-lg hover:bg-red-700 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isDeleting ? (
                    <>
